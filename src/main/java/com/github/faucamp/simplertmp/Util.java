...
public class Util {
    ...
    public static int readUnsignedInt32(ByteBuf in) throws IOException {
    ...
    public static int readUnsignedInt24(ByteBuf in) throws IOException {
        return ((in.readByte() & 0xff) << 16) | ((in.readByte() & 0xff) << 8) | (in.readByte() & 0xff);
    }
    public static int readUnsignedInt16(ByteBuf in) throws IOException {
    ...
    public static void readBytesUntilFull(ByteBuf in, byte[] targetBuffer) throws IOException {
        in.readBytes(targetBuffer, 0, targetBuffer.length);
    }
    ...
    public static double readDouble(ByteBuf in) throws IOException {
        long bits = ((long) (in.readByte() & 0xff) << 56) | ((long) (in.readByte() & 0xff) << 48) | ((long) (in.readByte() & 0xff) << 40) | ((long) (in.readByte() & 0xff) << 32) | ((in.readByte() & 0xff) << 24) | ((in.readByte() & 0xff) << 16) | ((in.readByte() & 0xff) << 8) | (in.readByte() & 0xff);

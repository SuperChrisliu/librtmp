...
public class Command extends VariableBodyRtmpPacket {
    ...
    public Command(String commandName, int transactionId, byte cid) {
        super(new RtmpHeader(RtmpHeader.ChunkType.TYPE_0_FULL, cid, RtmpHeader.MessageType.COMMAND_AMF0));
        this.commandName = commandName;
        this.transactionId = transactionId;
    }
    ...
    @Override
    public void readBody(ByteBuf in) throws IOException {
        ...
        transactionId = (int) Util.readDouble(in);
